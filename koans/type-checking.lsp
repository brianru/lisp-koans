...
(define-test test-check-some-common-types
   ...
   (true-or-false? ()  (typep "hello" 'list))
...
(define-test test-lisp-type-system-is-hierarchy
   ...
   (true-or-false? () (subtypep (type-of 2) (type-of 1))))
...
(define-test test-type-specifier-lists-also-have-hierarchy
   ...
   (true-or-false? () (subtypep '(vector double-float 100) '(array number *)))
   (true-or-false? t (subtypep '(vector double-float 100) t)))


(define-test test-type-coersion
   (assert-true (typep 0 'integer))
   (true-or-false? () (typep 0 'short-float))
   (true-or-false? () (subtypep 'integer 'short-float))
   (true-or-false? () (subtypep 'short-float 'integer))
...
(define-test test-functionp
  ...
  (true-or-false? () (functionp '(1 2 3)))
  (true-or-false? () (functionp t)))
