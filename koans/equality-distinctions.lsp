...
(define-test test-eq
  ...
  (true-or-false? () (eq 3 3.0))
  (true-or-false? () (eq '(1 2) '(1 2)))
  (true-or-false? () (eq "Foo" "Foo"))
  (true-or-false? () (eq "Foo" (copy-seq "Foo")))
  (true-or-false? () (eq "FOO" "Foo")))
...
(define-test test-eql
   ...
   (true-or-false? () (eql 3 3.0))
   (true-or-false? () (eql '(1 2) '(1 2)))
   (true-or-false? () (eql  '(:a . :b) '(:a . :b)))
   (true-or-false? t (eql #\S #\S))
   (true-or-false? () (eql "Foo" "Foo"))
   (true-or-false? () (eql "Foo" (copy-seq "Foo")))
   (true-or-false? () (eql "FOO" "Foo")))
...
(define-test test-equalp
   ...
   (true-or-false? () (equalp  '(:a . :b) '(:a . :doesnt-match)))
